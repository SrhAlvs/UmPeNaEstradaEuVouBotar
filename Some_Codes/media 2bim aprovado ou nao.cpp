...
int main ()
{
	...
	printf ("Este programa calcula a média de duas matérias por dois bimestres e ao final diz se foi aprovado ou não. Insira a nota do primeiro bimestre da primeira matéria:"); 	//mostrar na tela
	scanf ("%f",&m1b1); 	//receber do usuário
	printf ("Insira a nota do segundo bimestre da primeira matéria:"); 	//mostrar na tela
	scanf ("%f",&m1b2); 	//receber do usuário
	printf ("Insira a nota do primeiro bimestre da segunda matéria:"); 	//mostrar na tela
	scanf ("%f",&m2b1); 	//receber do usuário
	printf ("Insira a nota do segundo bimestre da segunda matéria:"); 	//mostrar na tela
