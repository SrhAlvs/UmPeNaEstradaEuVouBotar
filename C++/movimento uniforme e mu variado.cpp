...
int main () {
	...
	printf ("\nDigite 1 para selecionar o cálculo do movimento uniforme ou 2 para o cálculo do movimento uniforme variado:"); 	//mostrar na tela
	...
	if (Escolha==1){ 	//se sim:
		...
		if (Escolha==2){ 	//se sim:
			...
			printf ("\nNenhuma opçção foi selecionada."); 	//mostrar na tela
		}
	}
} 	//fim
